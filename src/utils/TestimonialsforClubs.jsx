...
import testimonials3 from '../javascript/data/testimonial3';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 group">
          {testimonials3.map((testimonials3) => (
            <TestimonialCard key={testimonials3.id} testimonial={testimonials3} />
          ))}
        </div>
      </div>
    </section>
...
export default TestimonialsforClubs;
