            ...
            <div className="container px-5 pt-24 pb-44 mx-auto">
                ...
                <div className="flex flex-wrap -m-4 justify-center">
                    ...
                    <div className="p-4 md:w-1/2 lg:w-1/3">
                        <div className="h-full  rounded-xl shadow-md transform transition-all hover:shadow-2xl hover:scale-105">
                            <div className="h-40 flex items-center justify-center bg-white rounded-t-xl">
                                <img className="w-24 h-24 object-cover object-center " src={images.img1} alt="15,000+ STUDENTS" />
                            </div>
                            <div className="p-6">
                    ...
                    <div className="p-4 md:w-1/2 lg:w-1/3">
                        <div className="h-full  rounded-xl shadow-md transform transition-all hover:shadow-2xl hover:scale-105">
                            <div className="h-40 flex items-center justify-center bg-white rounded-t-xl">
                                <img className="w-24 h-24 object-cover object-center " src={images.img2} alt="600+ INTERNSHIPS" />
                            </div>
                            <div className="p-6">
                    ...
                    <div className="p-4 md:w-1/2 lg:w-1/3">
                        <div className="h-full  rounded-xl shadow-md transform transition-all hover:shadow-2xl hover:scale-105">
                            <div className="h-40 flex items-center justify-center bg-white rounded-t-xl">
                                <img className="w-24 h-24 object-cover object-center " src={images.img3} alt="30+ COURSES" />
                            </div>
                            <div className="p-6">
                    ...
                    <div className="p-4 md:w-1/2 lg:w-1/3">
                        <div className="h-full  rounded-xl shadow-md transform transition-all hover:shadow-2xl hover:scale-105 relative group">
                            <div className="h-40 flex items-center justify-center bg-white rounded-t-xl">
                                <img className="w-24 h-24 object-cover object-center " src={images.img4} alt="50+ iconANIES COLLABORATED" />
                            </div>
                            <div className="p-6">
                    ...
                    <div className="p-4 md:w-1/2 lg:w-1/3">
                        <div className="h-full  rounded-xl shadow-md transform transition-all hover:shadow-2xl hover:scale-105 relative group">
                            <div className="h-40 flex items-center justify-center bg-white rounded-t-xl">
                                <img className="w-24 h-24 object-cover object-center " src={images.img5} alt="7+ CLUBS" />
                            </div>
                            <div className="p-6">
                    ...
                    <div className="p-4 md:w-1/2 lg:w-1/3">
                        <div className="h-full  rounded-xl shadow-md transform transition-all hover:shadow-2xl hover:scale-105 relative group">
                            <div className="h-40 flex items-center justify-center bg-white rounded-t-xl">
                                <img className="w-24 h-24 object-cover object-center " src={images.img6} alt="15+ COLLEGES" />
                            </div>
                            <div className="p-6">
